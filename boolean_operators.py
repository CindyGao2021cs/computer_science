...
if(is_chang_jung_student and is_computer_science_student):
    ...
    print("You are noy in  my computer science class")
...
if(is_chang_jung_student and is_computer_science_student):
    print("You are in my computer science school")
elif(is_chang_jung_stident and not is_computer_science_student):
    print("You are not in my computer science school")